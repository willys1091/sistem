...
class PublicUrlController extends Controller{
    ...
    public function contractView(Request $request, $hash){
        ...
        $pageIcon = 'fa fa-file';
        $contract = Contract::where('hash', $hash)->withoutGlobalScope(ActiveScope::class)->firstOrFail()->withCustomFields();
    ...
    public function estimateView($hash){
        ...
        $items = EstimateItem::whereNotNull('taxes')->where('estimate_id', $estimate->id)->get();
    ...
    public function domPdfObjectForDownload($id){
        ...
        $taxList = array();
        $items = EstimateItem::whereNotNull('taxes')->where('estimate_id', $this->estimate->id)->get();

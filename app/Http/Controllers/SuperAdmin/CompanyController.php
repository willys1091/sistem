...
class CompanyController extends AccountBaseController{
    ...
    public function store(StoreRequest $request){
        ...
        $currency = Currency::where('currency_code', $globalCurrency->currency_code)->where('company_id', $company->id)->first();
    ...
    public function show($id){
        ...
        $this->latestInvoice = GlobalInvoice::where('company_id', $this->company->id)->whereNotNull('pay_date')->latest()->first();

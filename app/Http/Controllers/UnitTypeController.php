...
class UnitTypeController extends AccountBaseController{
    ...
    public function store(UnitTypeRequest $request){
        ...
        $unit_type->unit_type2 = $request->unit_type2;
        $unit_type->unit_type3 = $request->unit_type3;
        $unit_type->save();
    ...
    public function update(UnitTypeRequest $request, $id){
        ...
        $unitType->unit_type2 = strip_tags($request->unit_type2);
        $unitType->unit_type3 = strip_tags($request->unit_type3);
        $unitType->save();
    ...
    public function destroy($id){
        $unitExists1 = Product::where('company_id', company()->id)->where('unit_id', $id)->first();

...
class ReimbursementReportDataTable extends BaseDataTable{
    ...
    {
        $dataTable = $this->setBuilder('reimbursement-report-table')
            ->parameters([
                'initComplete' => 'function () {
                   window.LaravelDataTables["reimbursement-report-table"].buttons().container()
                    .appendTo("#table-actions")
                }',
                'fnDrawCallback' => 'function( oSettings ) {
                    $("#reimbursement-report-table .select-picker").selectpicker();
                }',
            ]);
    ...
    protected function getColumns()
    {
        return [
            ...
            __('modules.reimbursements.purchaseFrom') => ['data' => 'purchase_from', 'name' => 'purchase_from', 'title' => __('modules.reimbursements.purchaseFrom')],
            ...
            __('modules.reimbursements.reimbursementBill') => ['data' => 'export_bill', 'name' => 'export_bill', 'visible' => false, 'title' => __('modules.reimbursements.reimbursementBill')],

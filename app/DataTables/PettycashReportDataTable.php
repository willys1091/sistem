...
class PettycashReportDataTable extends BaseDataTable{
    ...
    public function html(){
        $dataTable = $this->setBuilder('pettycash-report-table')
            ->parameters([
                'initComplete' => 'function () {
                   window.LaravelDataTables["pettycash-report-table"].buttons().container()
                    .appendTo("#table-actions")
                }',
                'fnDrawCallback' => 'function( oSettings ) {
                    $("#pettycash-report-table .select-picker").selectpicker();
                }',
            ]);
    ...
    protected function getColumns(){
        return [
            ...
            __('modules.pettycashes.purchaseFrom') => ['data' => 'purchase_from', 'name' => 'purchase_from', 'title' => __('modules.pettycashes.purchaseFrom')],
            ...
            __('modules.pettycashes.pettycashBill') => ['data' => 'export_bill', 'name' => 'export_bill', 'visible' => false, 'title' => __('modules.pettycashes.pettycashBill')],

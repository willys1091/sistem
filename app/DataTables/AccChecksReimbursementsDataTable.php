...
class AccChecksReimbursementsDataTable extends BaseDataTable{
    use General;
    ...
    public function dataTable($query){
        ...
        $datatables->addColumn('action', function ($row) {
            ...
            $action .= '<a class="task_view_more d-flex align-items-center justify-content-center text-success check" href="javascript:;" data-reimbursement-id="' . $row->id . '"><i class="fa fa-check mr-2"></i></a>';
            $action .= '</div>';
            return $action;
        });
    ...
    public function query(){
        ...
        $model->whereRaw("`reimbursements`.`status`= 'paid'");

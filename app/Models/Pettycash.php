...
class Pettycash extends BaseModel{
    ...
    const FILE_PATH = 'pettycash-invoice';
    const CUSTOM_FIELD_MODEL = 'App\Models\Pettycash';
    ...
    public function PettycashApproval(): HasMany{
        return $this->hasMany(PettycashApproval::class);
    }

    public function PettycashDetail(): HasMany{
    ...
    public function transactions(): HasMany{
        return $this->hasMany(BankTransaction::class, 'pettycash_id');
    }

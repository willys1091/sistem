...
class PettycashRecurring extends BaseModel{
    ...
    {
        return $this->belongsTo(PettycashesCategory::class, 'category_id');
    }

    public function recurrings(): HasMany
    {
        return $this->hasMany(Pettycash::class, 'pettycashes_recurring_id');
    }
    ...
    {
        return ($this->bill) ? asset_url_local_s3(Pettycash::FILE_PATH . '/' . $this->bill) : '';
    }

...
use App\Http\Controllers\FinanceExecutorController;
use App\Http\Controllers\AccCheckController;
...
Route::group(['middleware' => ['auth', 'multi-company-select', 'email_verified'], 'prefix' => 'account'], function () {
    ...
    Route::group(['prefix' => 'expenses'], function () {
        ...
        Route::get('approvalList/{id}', [ExpenseController::class, 'approvalList'])->name('expenses.approval_list');
        Route::get('response/{id}/{actid}', [ExpenseController::class, 'response'])->name('expenses.response');
        Route::get('download/{id}', [ExpenseController::class, 'download'])->name('expenses.download');
        Route::get('detail/create', [ExpenseController::class, 'detailCreate'])->name('expenses.detail.create');
        Route::post('detail/store', [ExpenseController::class, 'detailStore'])->name('expenses.detail.store');
        Route::get('detail/{id}/edit', [ExpenseController::class, 'detailEdit'])->name('expenses.detail.edit');
        Route::post('detail/{id}/update', [ExpenseController::class, 'detailUpdate'])->name('expenses.detail.update');
        Route::delete('detail/{id}/delete', [ExpenseController::class, 'detailDelete'])->name('expenses.detail.destroy');
        Route::post('response', [ExpenseController::class, 'responseAction'])->name('expenses.response_action');
        Route::post('copy', [ExpenseController::class, 'copy'])->name('expenses.copy');
        Route::post('check-approval', [ExpenseController::class, 'checkApproval'])->name('expenses.check_approval');
        Route::post('check-category-detail', [ExpenseController::class, 'checkCategoryDetail'])->name('expenses.check_category_detail');
    });
    ...
    Route::group(['prefix' => 'reimbursements'], function () {
        Route::post('recurring-reimbursements/change-status', [RecurringReimbursementController::class, 'changeStatus'])->name('recurring-reimbursements.change_status');
        Route::resource('recurring-reimbursements', RecurringReimbursementController::class);
        Route::get('change-status', [ReimbursementController::class, 'getEmployeeProjects'])->name('reimbursements.get_employee_projects');
        Route::get('category', [ReimbursementController::class, 'getCategoryEmployee'])->name('reimbursements.get_category_employees');
        Route::post('change-status', [ReimbursementController::class, 'changeStatus'])->name('reimbursements.change_status');
        Route::post('apply-quick-action', [ReimbursementController::class, 'applyQuickAction'])->name('reimbursements.apply_quick_action');
        Route::get('approvalList/{id}', [ReimbursementController::class, 'approvalList'])->name('reimbursements.approval_list');
        Route::get('response/{id}/{actid}', [ReimbursementController::class, 'response'])->name('reimbursements.response');
        Route::get('download/{id}', [ReimbursementController::class, 'download'])->name('reimbursements.download');
        Route::get('detail/create', [ReimbursementController::class, 'detailCreate'])->name('reimbursements.detail.create');
        Route::post('detail/store', [ReimbursementController::class, 'detailStore'])->name('reimbursements.detail.store');
        Route::get('detail/{id}/edit', [ReimbursementController::class, 'detailEdit'])->name('reimbursements.detail.edit');
        Route::post('detail/{id}/update', [ReimbursementController::class, 'detailUpdate'])->name('reimbursements.detail.update');
        Route::delete('detail/{id}/delete', [ReimbursementController::class, 'detailDelete'])->name('reimbursements.detail.destroy');
        Route::post('response', [ReimbursementController::class, 'responseAction'])->name('reimbursements.response_action');
        Route::post('copy', [ReimbursementController::class, 'copy'])->name('reimbursements.copy');
        Route::post('check-approval', [ReimbursementController::class, 'checkApproval'])->name('reimbursements.check_approval');
        Route::post('check-category-detail', [ReimbursementController::class, 'checkCategoryDetail'])->name('reimbursements.check_category_detail');
    });
    Route::resource('reimbursements', ReimbursementController::class);
    Route::resource('reimbursementCategory', ReimbursementCategoryController::class);

    // Pettycashes
    Route::group(['prefix' => 'pettycashes'], function () {
        Route::post('recurring-pettycashes/change-status', [RecurringPettycashController::class, 'changeStatus'])->name('recurring-pettycashes.change_status');
        Route::resource('recurring-pettycashes', RecurringPettycashController::class);
        Route::get('change-status', [PettycashController::class, 'getEmployeeProjects'])->name('pettycashes.get_employee_projects');
        Route::get('category', [PettycashController::class, 'getCategoryEmployee'])->name('pettycashes.get_category_employees');
        Route::post('change-status', [PettycashController::class, 'changeStatus'])->name('pettycashes.change_status');
        Route::post('apply-quick-action', [PettycashController::class, 'applyQuickAction'])->name('pettycashes.apply_quick_action');
        Route::get('approvalList/{id}', [PettycashController::class, 'approvalList'])->name('pettycashes.approval_list');
        Route::get('response/{id}/{actid}', [PettycashController::class, 'response'])->name('pettycashes.response');
        Route::get('download/{id}', [PettycashController::class, 'download'])->name('pettycashes.download');
        Route::get('detail/create', [PettycashController::class, 'detailCreate'])->name('pettycashes.detail.create');
        Route::post('detail/store', [PettycashController::class, 'detailStore'])->name('pettycashes.detail.store');
        Route::get('detail/{id}/edit', [PettycashController::class, 'detailEdit'])->name('pettycashes.detail.edit');
        Route::post('detail/{id}/update', [PettycashController::class, 'detailUpdate'])->name('pettycashes.detail.update');
        Route::delete('detail/{id}/delete', [PettycashController::class, 'detailDelete'])->name('pettycashes.detail.destroy');
        Route::post('response', [PettycashController::class, 'responseAction'])->name('pettycashes.response_action');
        Route::post('copy', [PettycashController::class, 'copy'])->name('pettycashes.copy');
        Route::post('check-approval', [PettycashController::class, 'checkApproval'])->name('pettycashes.check_approval');
        Route::post('check-category-detail', [PettycashController::class, 'checkCategoryDetail'])->name('pettycashes.check_category_detail');
    });
    Route::resource('pettycashes', PettycashController::class);
    Route::resource('pettycashCategory', PettycashCategoryController::class);

    // settlements
    Route::group(['prefix' => 'settlements'], function () {
        Route::post('change-status', [SettlementController::class, 'changeStatus'])->name('settlements.change_status');
        Route::post('apply-quick-action', [SettlementController::class, 'applyQuickAction'])->name('settlements.apply_quick_action');
        Route::get('response/{id}/{actid}', [SettlementController::class, 'response'])->name('settlements.response');
        Route::get('approvalList/{id}', [SettlementController::class, 'approvalList'])->name('settlements.approval_list');
        Route::get('response/{id}/{actid}', [SettlementController::class, 'response'])->name('settlements.response');
        Route::get('download/{id}', [SettlementController::class, 'download'])->name('settlements.download');
        Route::get('detail/create', [SettlementController::class, 'detailCreate'])->name('settlements.detail.create');
        Route::post('detail/store', [SettlementController::class, 'detailStore'])->name('settlements.detail.store');
        Route::get('detail/{id}/edit', [SettlementController::class, 'detailEdit'])->name('settlements.detail.edit');
        Route::post('detail/{id}/update', [SettlementController::class, 'detailUpdate'])->name('settlements.detail.update');
        Route::delete('detail/{id}/delete', [SettlementController::class, 'detailDelete'])->name('settlements.detail.destroy');
        Route::post('response', [SettlementController::class, 'responseAction'])->name('settlements.response_action');
        Route::post('copy', [SettlementController::class, 'copy'])->name('settlements.copy');
        Route::post('check-approval', [SettlementController::class, 'checkApproval'])->name('settlements.check_approval');
    });
    Route::resource('settlements', SettlementController::class);

    Route::group(['prefix' => 'financeExecutors'], function () {
        Route::get('expenses/{id}/paid', [FinanceExecutorController::class, 'expensesPaid'])->name('financeExecutors.expenses.paid');
        Route::post('expenses/actionPaid', [FinanceExecutorController::class, 'actionExpensesPaid'])->name('financeExecutors.expenses.actionPaid');
        Route::get('reimbursements/{id}/paid', [FinanceExecutorController::class, 'reimbursementsPaid'])->name('financeExecutors.reimbursements.paid');
        Route::post('reimbursements/actionPaid', [FinanceExecutorController::class, 'actionReimbursementsPaid'])->name('financeExecutors.reimbursements.actionPaid');
        Route::get('settlements/{id}/paid', [FinanceExecutorController::class, 'settlementsPaid'])->name('financeExecutors.settlements.paid');
        Route::post('settlements/actionPaid', [FinanceExecutorController::class, 'actionSettlementsPaid'])->name('financeExecutors.settlements.actionPaid');
    });
    Route::resource('financeExecutors', FinanceExecutorController::class);

    Route::group(['prefix' => 'accChecks'], function () {
        Route::get('expenses/{id}/check', [AccCheckController::class, 'expensesCheck'])->name('accChecks.expenses.check');
        Route::post('expenses/actionCheck', [AccCheckController::class, 'actionExpensesCheck'])->name('accChecks.expenses.actionCheck');
        Route::get('reimbursements/{id}/check', [AccCheckController::class, 'reimbursementsCheck'])->name('accChecks.reimbursements.check');
        Route::post('reimbursements/actionCheck', [AccCheckController::class, 'actionReimbursementsCheck'])->name('accChecks.reimbursements.actionCheck');
        Route::get('settlements/{id}/check', [AccCheckController::class, 'settlementsCheck'])->name('accChecks.settlements.check');
        Route::post('settlements/actionCheck', [AccCheckController::class, 'actionSettlementsCheck'])->name('accChecks.settlements.actionCheck');
    });
    Route::resource('accChecks', AccCheckController::class);
    ...
    Route::resource('fa-report', FaReportController::class);

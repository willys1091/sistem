    ...
    <div class="col-sm-12">
        <x-form id="save-product-form">
            ...
            <div class="add-client bg-white rounded">
                <h4 class="mb-0 p-20 f-21 font-weight-normal text-capitalize border-bottom-grey">@lang('app.menu.addProducts')</h4>
                <div class="row p-20">
                    <div class="col-lg-12">
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-6">
                                ...
                                <div class="form-group">
                                    <div class="d-flex">
                                        <x-forms.radio fieldId="goods_type" class="product_type" :fieldLabel="__('purchase::modules.product.goods')" fieldName="type" fieldValue="goods" :checked="(($product && $product->type == 'goods') ? 'true' : 'true')"></x-forms.radio>
                                        <x-forms.radio class="product_type" fieldId="service_type" :fieldLabel="__('purchase::modules.product.service')" fieldValue="service" fieldName="type" :checked="(($product && $product->type == 'service') ? 'true' : '')"></x-forms.radio>
                                    </div>
                                </div>
                            </div>

                            <div class="col-lg-4 col-md-6">
                                <x-forms.text fieldId="name" :fieldLabel="__('app.name')" fieldName="name" :fieldValue="$product ? $product->name : ''" fieldRequired="true" :fieldPlaceholder="__('placeholders.productName')"></x-forms.text>
                            </div>

                            <div class="col-lg-4 col-md-6" id="sku_id">
                                <x-forms.text fieldId="sku" :fieldLabel="__('purchase::app.sku')" fieldName="sku" :fieldValue="$product ? $product->sku : ''" :fieldPlaceholder="__('placeholders.hsnSac')"></x-forms.text>
                            </div>

                            <div class="col-lg-3 col-md-6">
                                <x-forms.label class="my-3" fieldId="" :fieldLabel="__('modules.unitType.unitType')"></x-forms.label>
                                <x-forms.input-group>
                                    <select class="form-control unit_type select-picker" name="unit_type" id="unit_type_id" data-live-search="true">
                                        @foreach ($unit_types as $unit_type)
                                            <option @if ($product && ($unit_type->id == $product->unit_id)) selected @elseif ($unit_type->default == 1) selected @endif value="{{ $unit_type->id }}">{{ ucwords($unit_type->unit_type) }} - {{ ucwords($unit_type->unit_type2) }} - {{ ucwords($unit_type->unit_type3) }}</option>
                                        @endforeach
                                    </select>
                                </x-forms.input-group>
                            </div>
                            ...
                            <div class="col-lg-3 col-md-6">
                                <x-forms.label class="my-3" fieldId="" :fieldLabel="__('purchase::app.convUnitType1')" fieldRequired="true"></x-forms.label>
                                <div class="input-group">
                                    <div class="input-group-prepend  height-35">
                                        <span class="input-group-text border-grey f-15 bg-additional-grey px-3 text-dark" id="unit_type1">{{ $def_unit_types->unit_type }}</span>
                                    </div>
                                    <input type="number" name="unit_type1" id="unit_type1" class="form-control height-35 f-15 readonly-background" placeholder="0"  aria-label="0019" aria-describedby="basic-addon1" min="0">   
                                </div>
                            </div>

                            <div class="col-lg-3 col-md-6">
                                <x-forms.label class="my-3" fieldId="" :fieldLabel="__('purchase::app.convUnitType2')" fieldRequired="true"></x-forms.label>
                                <div class="input-group">
                                    <div class="input-group-prepend  height-35">
                                        <span class="input-group-text border-grey f-15 bg-additional-grey px-3 text-dark" id="unit_type2">{{ $def_unit_types->unit_type2 }}</span>
                                    </div>
                                    <input type="number" name="unit_type2" id="unit_type2" class="form-control height-35 f-15 readonly-background" placeholder="0"  aria-label="0019" aria-describedby="basic-addon1" min="0">   
                                </div>
                            </div>

                            <div class="col-lg-3 col-md-6">
                                <x-forms.label class="my-3" fieldId="" :fieldLabel="__('purchase::app.convUnitType3')" fieldRequired="true"></x-forms.label>
                                <div class="input-group">
                                    <div class="input-group-prepend  height-35">
                                        <span class="input-group-text border-grey f-15 bg-additional-grey px-3 text-dark" id="unit_type3">{{ $def_unit_types->unit_type3 }}</span>
                                    </div>
                                    <input type="number" name="unit_type3" id="unit_type3" class="form-control height-35 f-15 readonly-background" placeholder="0"  aria-label="0019" aria-describedby="basic-addon1" min="0">   
                                </div>
                            </div>

                            <div class="col-lg-4 col-md-6">
                                <x-forms.label class="my-3" fieldId="" :fieldLabel="__('modules.productCategory.productCategory')"></x-forms.label>
                                <x-forms.input-group>
                            ...
                            <div class="col-lg-4 col-md-6">
                                <x-forms.label class="my-3" fieldId="" :fieldLabel="__('modules.productCategory.productSubCategory')"></x-forms.label>
                                <x-forms.input-group>
                            ...
                            <div class="col-md-6">
                                <div class="row mt-5">
                                    <div class="col-md-12">
                                        <x-forms.label class="" fieldId="sales_information" :fieldLabel="__('purchase::app.salesInformation')"></x-forms.label>
                                    </div>
                                </div>
                                <div class="row" id="salePrice">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label class="f-14 text-dark-grey mb-12 text-capitalize" for="selling_price">@lang('purchase::app.sellingPrice')<sup class="text-red f-14 mr-1">*</sup></label>
                                            <div class="input-group">
                                                <div class="input-group-prepend  height-35">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="row purchase_information" id="purchase_price_div">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label class="f-14 text-dark-grey mb-12 text-capitalize" for="purchase_price">@lang('purchase::app.costPrice')<sup class="text-red f-14 mr-1">*</sup></label>
                                            <div class="input-group">
                                                <div class="input-group-prepend  height-35 ">
                                                    <span class="input-group-text border-grey f-15 bg-additional-grey px-3 text-dark" id="basic-addon1">{{ company()->currency->currency_code }}</span>
                                                </div>
                            ...
                            <div class="col-lg-6 col-md-6">
                                <x-forms.label class="my-3" fieldId="" :fieldLabel="__('purchase::app.minQty')" fieldRequired="true"></x-forms.label>
                                <input type="number" name="min_qty" id="min_qty" class="form-control height-35 f-15 readonly-background" placeholder="0"  aria-label="0019" aria-describedby="basic-addon1" min="0">   
                            </div>

                            <div class="col-lg-6 col-md-6">
                                <x-forms.label class="my-3" fieldId="" :fieldLabel="__('purchase::app.maxQty')" fieldRequired="true"></x-forms.label>
                                <input type="number" name="max_qty" id="max_qty" class="form-control height-35 f-15 readonly-background" placeholder="0"  aria-label="0019" aria-describedby="basic-addon1" min="0">   
                            </div>

                            <div class="col-md-4 my-3">
                                <x-forms.label fieldId="" :fieldLabel="__('modules.invoices.tax')"></x-forms.label>
                                <x-forms.input-group>
                            ...
                            <div class="col-md-4">
                                <x-forms.text fieldId="hsn_sac_code" :fieldLabel="__('app.hsnSac')" fieldName="hsn_sac_code" :fieldValue="$product ? $product->hsn_sac_code : ''" :fieldPlaceholder="__('placeholders.hsnSac')"></x-forms.text>
                            </div>
                            ...
                            <div class="col-md-12 mt-3 track_inventory d-none">
                                <div class="row">
                                    <div class="col-md-6">
                                        <x-forms.number fieldId="opening_stock" fieldRequired="true" :fieldLabel="__('purchase::app.openingStock')" fieldName="opening_stock" :fieldPlaceholder="__('purchase::placeholders.openingStock')" :popover="__('purchase::app.availableStock')"></x-forms.number>
                                    </div>
                                </div>
                            </div>
                           ...
                           <div class="col-md-12 mt-3">
                                <div class="form-group">
                                    <x-forms.label class="my-3" fieldId="description-text" :fieldLabel="__('app.description')"></x-forms.label>
                ...
                <x-form-actions>
                    <x-forms.button-primary id="save-product" class="mr-3 px-0" icon="check">@lang('app.save')</x-forms.button-primary>
                    <x-forms.button-secondary class="mr-3" id="save-more-product" icon="check-double">@lang('app.saveAddMore')</x-forms.button-secondary>
...
<script>
    $(document).ready(function () {
        ...
        $('#unit_type_id').change(function (e) {
            let unit_type_id = $(this).val();
            $.ajax({
                type: "POST",
                url: "{{ route('purchase_products.get_uom') }}",
                data: {'_token': "{{ csrf_token() }}",unit_type_id: unit_type_id},
                cache: false,
                success: function(response){
                    $('#unit_type1').text(response['unit_type1']);
                    $('#unit_type2').text(response['unit_type2']);
                    $('#unit_type3').text(response['unit_type3']);
                }
            });
        });

...
Route::group(['middleware' => 'auth', 'prefix' => 'account'], function () {
    ...
    Route::post('purchase-products/get_uom', [PurchaseProductController::class, 'getUom'])->name('purchase_products.get_uom');
    ...
    Route::group(['prefix' => 'purchase-request'], function () {
        Route::get('change-status/{id}', [PurchaseRequestController::class, 'changeStatus'])->name('purchase_request.change_status');
        Route::get('add-item', [PurchaseRequestController::class, 'addItem'])->name('purchase_request.add_item');
        Route::post('send-request/{orderID}', [PurchaseRequestController::class, 'sendRequest'])->name('purchase_request.send_request');
        Route::get('download/{id}', [PurchaseRequestController::class, 'download'])->name('purchase_request.download');
        Route::get('approvalList/{id}', [PurchaseRequestController::class, 'approvalList'])->name('purchase_request.approval_list');
        Route::get('response/{id}/{actid}', [PurchaseRequestController::class, 'response'])->name('purchase_request.response');
        Route::get('detail/create', [PurchaseRequestController::class, 'detailCreate'])->name('purchase_request.detail.create');
        Route::post('detail/store', [PurchaseRequestController::class, 'detailStore'])->name('purchase_request.detail.store');
        Route::get('detail/{id}/edit', [PurchaseRequestController::class, 'detailEdit'])->name('purchase_request.detail.edit');
        Route::post('detail/{id}/update', [PurchaseRequestController::class, 'detailUpdate'])->name('purchase_request.detail.update');
        Route::delete('detail/{id}/delete', [PurchaseRequestController::class, 'detailDelete'])->name('purchase_request.detail.destroy');
        Route::post('response', [PurchaseRequestController::class, 'responseAction'])->name('purchase_request.response_action');
        Route::post('copy', [PurchaseRequestController::class, 'copy'])->name('purchase_request.copy');
        Route::post('check-approval', [PurchaseRequestController::class, 'checkApproval'])->name('purchase_request.check_approval');
        Route::post('get-uom', [PurchaseRequestController::class, 'getUom'])->name('purchase_request.get_uom');
    });
    ...
    Route::group(['prefix' => 'quotation'], function () {
        Route::get('change-status/{id}', [QuotationController::class, 'changeStatus'])->name('quotation.change_status');
        Route::post('send-request/{orderID}', [QuotationController::class, 'sendRequest'])->name('quotation.send_request');
        Route::get('approvalList/{id}', [QuotationController::class, 'approvalList'])->name('quotation.approval_list');
        Route::get('response/{id}/{actid}', [QuotationController::class, 'response'])->name('quotation.response');
        Route::post('response', [QuotationController::class, 'responseAction'])->name('quotation.response_action');
        Route::post('check-approval', [QuotationController::class, 'checkApproval'])->name('quotation.check_approval');
    });

...
class PurchaseProductController extends AccountBaseController{
    ...
    public function create(){
        ...
        $this->def_unit_types = UnitType::whereDefaultAndCompany_id(1,user()->company_id)->first();
    ...
    public function store(StorePurchaseProductRequest $request){
        ...
        $product->conv_unit = $request->unit_type1;
        $product->conv_unit2 = $request->unit_type2;
        $product->conv_unit3 = $request->unit_type3;
    ...
    public function edit($id){
        ...
        $this->categories = ProductCategory::all();
        $this->unit_types = UnitType::all();
        $this->def_unit_types = UnitType::findorfail($this->product->unit_id);
    ...
    public function getUom(Request $request){
        $uom = UnitType::findorfail($request->unit_type_id);
        return ['unit_type1'=>$uom->unit_type,'unit_type2'=>$uom->unit_type2,'unit_type3'=>$uom->unit_type3,];
    }

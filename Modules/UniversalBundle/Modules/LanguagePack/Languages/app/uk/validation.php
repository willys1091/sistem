...
return [
  ...
  'accepted_if' => 'Поле :attribute має бути прийнятним, якщо :other дорівнює :value.',
  ...
  'digits_between' => 'Знак :attribute має бути між цифрами :min і :max.',
  ...
  'attributes' => [
    ...
    'probation_end_date' => 'дата закінчення випробувального строку',

...
<div class="row">
    @if ($nonPaidInvoices->count() > 0)
        ...
        <div class="col-lg-12 col-md-12 mb-4 mb-xl-0 mb-lg-4 mb-md-0">
            <h4 class="my-3 f-21 text-capitalize font-weight-bold">{{ $vendorCredit->credit_note_no }}</h4>
            ...
            <h4 class="mt-5 mb-3 f-21 text-capitalize font-weight-bold">@lang('purchase::app.menu.vendor') @lang('app.unpaid')
                @lang('app.bill')</h4>
                            ...
                            <tr>
                                    <td>
                                        <a class="text-darkest-grey"
                                            href="{{ route('invoices.show', [$bill->id]) }}">{{ $bill->purchase_bill_number }}</a>
                                    </td>
                                    <td>
        ...
        <x-form-actions>
            ...
            <x-forms.button-cancel :link="route('creditnotes.show', $vendorCredit->id)" class="border-0">
                @lang('app.cancel')

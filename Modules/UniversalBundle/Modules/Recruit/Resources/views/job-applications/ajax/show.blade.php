                        ...
                        <div class="col-xl-9 col-lg-8 col-md-12 mb-4 mb-xl-0 mb-lg-4 mb-md-0">
                            <div class="progress mb-4 height-35">
                                ...
                                || ($application->applicationStatus->slug != 'rejected' && $application->applicationStatus->slug != 'hired' && $item->slug == 'hired'))
                                    ...
                                    <div class="progress-bar f-15 font-weight-semibold text-lightest progress-bar-striped" role="progressbar" style="width: {{ $progressValue }}%; background-color: {{ $item->color }}20;" aria-valuenow="{{ $progressValue }}" aria-valuemin="0" aria-valuemax="100" data-toggle="tooltip" data-original-title="@lang('recruit::modules.jobApplication.applicationNotMoved')">
                                        {{ $item->status }}
                                    </div>
                                @else
                                    <div class="progress-bar f-15 font-weight-semibold" role="progressbar" style="width: {{ $progressValue }}%; background-color: {{ $item->color }};" aria-valuenow="{{ $progressValue }}" aria-valuemin="0" aria-valuemax="100">
                                        &#x2714; {!! ($application->recruit_application_status_id == $item->id) ? '&#x2714;' : '' !!} {{ $item->status }}
                                    </div>
                                @endif

                ...
                <div class="card border-0 invoice">
                    ...
                    <div class="card-body">
                        <div class="invoice-table-wrapper">
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <h5 class="heading-h4 text-grey text-capitalize">@lang('recruit::modules.joboffer.candidateDetails')</h5>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <h5 class="heading-h4 text-grey text-capitalize">@lang('recruit::modules.joboffer.jobDetails')</h5>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <h5 class="heading-h4 text-grey text-capitalize">@lang('recruit::modules.joboffer.offerDetail')</h5>
                                </div>
                            </div>
                            ...
                            @if(!is_null($salaryStructure))
                                <h5 class="heading-h4 text-grey text-capitalize">@lang('recruit::modules.joboffer.salaryStructure')</h5>
                                <div class="row">
                                    <div class="col-6">

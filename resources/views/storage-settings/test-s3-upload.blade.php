    ...
    <div class="portlet-body">
        <x-form id="StorageUploadForm" method="POST" class="ajax-form">
            ...
            <div class="form-body">
                <div class="row">
                    <div class="col-lg-12">
                        <x-forms.file allowedFileExtensions="txt pdf doc xls xlsx docx rtf png jpg jpeg svg" class="mr-0 mr-lg-2 mr-md-2" :fieldLabel="__('app.storageSetting.uploadFile')" fieldName="file" fieldId="file" :popover="__('messages.fileFormat.multipleImageFile')"/>
                    </div>
                </div>
            </div>
        </x-form>
...
<div class="modal-footer">
    ...
    <x-forms.button-secondary class="btn-xs mr-3 d-none" id="show-file" icon="eye">@lang('app.storageSetting.viewFile')</x-forms.button-secondary>

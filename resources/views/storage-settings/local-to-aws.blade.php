...
<div class="modal-body">
    <div class="portlet-body">
                                ...
                                <table class="table table-bordered table-striped mb-0">
                                    ...
                                    <tbody>
                                        @foreach($files as $file)
                                            <tr>
                                                <td scope="row">
                                                    <a class="cursor-pointer d-block text-dark-grey f-13 pt-3 px-3 " target="_blank"href="{{ $file->file_url }}">
                                                        @if ($file->icon == 'images')
        ...
        @else
            <div class="mt-3"><x-alert type="info" icon="info-circle">@lang('messages.allFilesMovedToCloud')</x-alert></div>
        @endif
    </div>
</div>

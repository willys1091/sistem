...
<div class="col-lg-12 col-md-12 ntfcn-tab-content-left w-100 p-4 ">
    <div class="row">
        ...
        <div class="col-lg-3">
            ...
            <x-forms.input-group>
                <input type="number" name="allowed_file_size" id="allowed_file_size" value="{{ global_setting()->allowed_file_size }}" placeholder="32" class="form-control height-35 f-14"/>
        ...
        <div class="col-lg-4">
            ...
            <x-forms.input-group>
                <input type="number" name="allow_max_no_of_files" id="allow_max_no_of_files" value="{{ global_setting()->allow_max_no_of_files }}" placeholder="5" class="form-control height-35 f-14"/>
            </x-forms.input-group>
        </div>
        ...
        <div class="col-lg-12 mt-4">
            ...
            <textarea type="text" name="allowed_file_types" id="allowed_file_types" placeholder="@lang('placeholders.fileSetting')" class="form-control f-14">{{ global_setting()->allowed_file_types }}</textarea>
        </div>
    </div>
</div>
...
<div class="w-100 border-top-grey set-btns">
    <x-setting-form-actions>
        <x-forms.button-primary id="save-file-upload-setting-form" class="mr-3" icon="check">@lang('app.save')</x-forms.button-primary>
    </x-setting-form-actions>
</div>

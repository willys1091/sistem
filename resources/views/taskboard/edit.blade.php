...
<div class="modal-body">
    <x-form id="updateTaskBoardColumn" method="PUT">
        <div class="row">
            <div class="col-md-12">
                <x-forms.text class="mr-0 mr-lg-2 mr-md-2" :fieldLabel="__('modules.tasks.columnName')" fieldName="column_name" fieldId="column_name" :placeholder="__('placeholders.columnName')" :fieldValue="$boardColumn->column_name" fieldRequired="true" />
            </div>
            <div class="col-md-6">
            ...
            <div class="col-md-6">
                <div class="form-group my-3">
                    ...
                    <x-forms.input-group id="colorpicker">
                        <input type="text" class="form-control height-35 f-14" value="{{ $boardColumn->label_color }}" placeholder="{{ __('placeholders.colorPicker') }}" name="label_color" id="colorselector">

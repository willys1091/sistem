    ...
    <x-form id="edit-note-data-form" method="PUT">
        <div class="row">
            <div class="col-md-12 p-20 ">
                <div class="media">
                    <img src="{{ $note->user->image_url }}" class="align-self-start mr-3 taskEmployeeImg rounded" alt="{{ $note->user->name }}">
                    <div class="media-body bg-white">
                        <div class="form-group">
                            <div id="task-edit-note">{!! $note->note !!}</div>
                            <textarea name="note" class="form-control invisible d-none" id="task-edit-note-text">{!!  $note->note !!}</textarea>
                        </div>
                    </div>
                </div>
            </div>

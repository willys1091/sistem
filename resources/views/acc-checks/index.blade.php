...
@section('filter-section')
    <div class="d-flex d-lg-block filter-box project-header bg-white">
        ...
        <div class="project-menu" id="mob-client-detail">
            ...
            <nav class="tabs">
                <ul class="-primary">
                    <li><x-tab :href="route('accChecks.index')" :text="__('app.menu.expenses')" class="expenses"/></li>
                    <li><x-tab :href="route('accChecks.index').'?tab=settlements'" :text="__('app.menu.settlements')" ajax="false" class="settlements"/></li>
                    {{-- <li><x-tab :href="route('accChecks.index').'?tab=reimbursements'" :text="__('app.menu.reimbursements')" ajax="false" class="reimbursements"/></li> --}}
                </ul>
            </nav>
        </div>

            ...
            <x-slot name="buttons">
                <div class="row">
                    <div class="col-md-12 mb-2">
                        <x-forms.button-primary icon="users-cog" id="add-role" class="mb-2">@lang('modules.roles.addRole')</x-forms.button-primary>
                    </div>
                </div>
            </x-slot>
                ...
                @forelse($roles as $role)
                    <div class="d-flex justify-content-between border rounded my-3 px-4 py-2 align-items-center">
                        <div>
                            ...
                            <div class="simple-text text-lightest mt-1">{{ $role->users_count }} @lang('app.member')</div>
                        </div>
                        <div>
                            {{-- @if ($role->name == 'admin')

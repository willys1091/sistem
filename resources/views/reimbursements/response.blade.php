...
<x-form id="save-reimbursement-data-form">
    <div class="modal-body">
        <div class="portlet-body">
            ...
            @elseif($act[0] == 'Acc' && $act[1] == 'Approve')
                <div class="row">
                    <div class="col-md-6">
                        <x-forms.text :fieldLabel="__('modules.reimbursements.accNo')" fieldName="acc_no" fieldId="acc_no" fieldRequired="true"/>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group my-3">
                            <x-forms.label class="mt-3" fieldId="image"  :fieldLabel="__('app.attachmentFile')" :popover="__('messages.fileFormat.ImageFile')"></x-forms.label><br>
                            <input type="file" class="dropify" id="image" name="bill" @if (!is_null("png jpg jpeg svg bmp")) data-allowed-file-extensions="png jpg jpeg svg bmp" @endif data-height="119"/>
                        </div>
...
<script>
    $(document).ready(function() {
        ...
        $('#save-reimbursement-form').click(function() {
            ...
            const url = "{{ route('reimbursements.response_action') }}";

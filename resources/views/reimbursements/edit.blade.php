...
@section('content')
    <div class="content-wrapper">
        <div class="bg-white rounded b-shadow-4 create-inv">
            <div class="px-lg-4 px-md-4 px-3 py-3"><h4 class="mb-0 f-21 font-weight-normal text-capitalize">@lang('app.estimateDetails')</h4></div>
            ...
            <x-form class="c-inv-form" id="saveInvoiceForm">@method('PUT')
                <div class="row px-lg-4 px-md-4 px-3 py-3">
                    <div class="col-md-6 col-lg-4">
                        <div class="form-group mb-lg-0 mb-md-0 mb-4">
                            ...
                            <div class="input-group"><input type="text" name="estimate_number" id="estimate_number" class="form-control height-35 f-15 readonly-background" readonly value="{{ $estimate->estimate_number }}" ></div>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-4">
                        <div class="form-group mb-lg-0 mb-md-0 mb-4">
                            <x-forms.label fieldId="due_date" :fieldLabel="__('modules.estimates.validTill')"></x-forms.label>
                ...
                <div class="row px-lg-4 px-md-4 px-3 pt-3">
                    <div class="col-md-6">
                        <div class="form-group c-inv-select mb-4">
                            <x-forms.label fieldId="client_id" :fieldLabel="__('app.client')" fieldRequired="true"></x-forms.label>
                     ...
                     <div class="col-md-6">
                        <div class="form-group c-inv-select mb-4">
                            <x-forms.label fieldId="client_id" :fieldLabel="__('app.status')"></x-forms.label>
                            <select class="form-control select-picker" name="status" id="status">
                                <option @selected($estimate->status == 'accepted') value="accepted">@lang('modules.estimates.accepted')</option>
                                <option @selected($estimate->status == 'waiting') value="waiting">@lang('modules.estimates.waiting')</option>
                                <option @selected($estimate->status == 'declined') value="declined">@lang('modules.estimates.declined')</option>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="border-bottom-0 btrr-mbl btlr">
                                        <input type="text" class="f-14 border-0 w-100 item_name" name="item_name[]" placeholder="@lang('modules.reimbursements.itemName')" value="{{ $item->item_name }}">
                                    </td>
                            ...
                            <tr>
                                ...
                                <td width="50%" class="p-0 border-0">
                                    <table width="100%">
                                        <tbody>
                                            <tr>
                                                <td colspan="2" class="border-top-0 text-dark-grey">@lang('modules.invoices.subTotal')</td>
                                            ...
                                            <tr>
                                                <td width="30%" class="text-dark-grey">@lang('modules.invoices.discount')</td>
                ...
                <div class="d-flex flex-wrap px-lg-4 px-md-4 px-3 py-3">
                    ...
                    <div class="col-md-6 col-sm-12 p-0 c-inv-note-terms">
                        <label class="f-14 text-dark-grey mb-12 text-capitalize w-100" for="usr">@lang('modules.invoiceSettings.invoiceTerms')</label>
                ...
                +'<table width="100%">'
                    +'<tbody>'
                        +'<tr class="text-dark-grey font-weight-bold f-14">'
                            ...
                            +'<tr>'
                                +'<td class="border-bottom-0 btrr-mbl btlr">'
                                    +`<input type="text" class="f-14 border-0 w-100 item_name" name="item_name[]" placeholder="@lang('modules.reimbursements.itemName')">`
                                    +'</td>'
                                    +'<td class="border-bottom-0 d-block d-lg-none d-md-none">'

<x-form id="save-reimbursement-data-form">
    ...
    <div class="modal-body">
        <div class="portlet-body">
            <div class="row">
                <div class="col-md-12">
                    <x-forms.text :fieldLabel="__('modules.reimbursements.remarks')" fieldName="remarks" fieldRequired="true" fieldId="remarks" :fieldValue="$detail->remarks" autocomplete="off"/>
                </div>
                <div class="col-md-12">
                ...
                <div class="col-md-6">
                    <x-forms.datepicker fieldId="purchase_date" fieldRequired="true" :fieldLabel="__('modules.reimbursements.purchaseDate')" fieldName="estdate" :fieldPlaceholder="__('placeholders.date')" :fieldValue="$detail->estdate->format(company()->date_format)" />
                </div>
            </div>
        </div>
    </div>
...
<script>
    $(document).ready(function() {
        ...
        $('#save-reimbursement-form').click(function() {
            const url = "{{ route('reimbursements.detail.update', $detail->id) }}";

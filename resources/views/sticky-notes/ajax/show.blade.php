@switch($stickyNotes->colour)
    @case('green')
        @php $colour = 'dark-green'; @endphp
    @break
    @case('purple')
        @php $colour = 'dark-grey'; @endphp
    @break
    @default
        @php $colour = $stickyNotes->colour; @endphp
@endswitch
        ...
        <div class="col-sm-12">
            <div class="card bg-white border-0 b-shadow-4">
                <div class="card-header bg-white  border-bottom-grey text-capitalize justify-content-between p-20">
                    <div class="row">
                        <div class="col-10"><h3 class="heading-h1 mb-3">@lang('app.noteDetails')</h3></div>
                        <div class="col-2 text-right">
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right border-grey rounded b-shadow-4 p-0" aria-labelledby="dropdownMenuLink" tabindex="0">
                                    <a class="dropdown-item openRightModal" href="{{ route('sticky-notes.edit', $stickyNotes->id) }}">@lang('app.edit')</a>
                                    <a class="dropdown-item delete-snote" data-note-id="{{ $stickyNotes->id }}">@lang('app.delete')</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card-body">
                    <x-cards.data-row :label="__('modules.sticky.colors')" value="<i class='fa fa-square f-21 mr-2 text-{{ $colour }}'></i>" html="true" />

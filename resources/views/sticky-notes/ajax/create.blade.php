    ...
    <div class="col-sm-12">
        <x-form id="save-notice-data-form">
            <div class="add-client bg-white rounded">
                <h4 class="mb-0 p-20 f-21 font-weight-normal text-capitalize border-bottom-grey">@lang('app.noteDetails')</h4>
                <div class="row p-20">
                    ...
                    <div class="col-lg-12"><x-forms.textarea :fieldLabel="__('app.note')" fieldName="notetext" fieldId="notetext" /></div>
                </div>
                <x-form-actions>

    ...
    @if ((in_array('estimates', user_modules()) || in_array('invoices', user_modules()) || in_array('payments', user_modules()) || in_array('expenses', user_modules()) || in_array('reimbursements', user_modules()) || in_array('settlements', user_modules()) || in_array('bankaccount', user_modules())) && ($sidebarUserPermissions['view_estimates'] != 5 || $sidebarUserPermissions['view_invoices'] != 5 || $sidebarUserPermissions['view_payments'] != 5 || $sidebarUserPermissions['view_expenses'] != 5 || $sidebarUserPermissions['view_lead_proposals'] != 5 || $sidebarUserPermissions['view_bankaccount'] != 5) && ($sidebarUserPermissions['view_estimates'] != 'none' || $sidebarUserPermissions['view_invoices'] != 'none' || $sidebarUserPermissions['view_payments'] != 'none' || $sidebarUserPermissions['view_expenses'] != 'none' || $sidebarUserPermissions['view_lead_proposals'] != 'none' || $sidebarUserPermissions['view_bankaccount'] != 'none'))
        ...
        <x-menu-item icon="cash-coin" :active="($currentRouteName === 'payments.index')" :text="__('app.menu.finance')">
            ...
            <div class="accordionItemContent pb-2">
                ...
                @endif
                @if (in_array('reimbursements', user_modules()) && $sidebarUserPermissions['view_reimbursements'] != 5 && $sidebarUserPermissions['view_reimbursements'] != 'none')
                    <x-sub-menu-item :link="route('reimbursements.index')" :text="__('app.menu.reimbursements')" />
                @endif
                @if (in_array('settlements', user_modules()) && $sidebarUserPermissions['view_settlements'] != 5 && $sidebarUserPermissions['view_settlements'] != 'none')
                    <x-sub-menu-item :link="route('settlements.index')" :text="__('app.menu.settlements')" />
                @endif
                @if (in_array('pettycashes', user_modules()) && $sidebarUserPermissions['view_pettycashes'] != 5 && $sidebarUserPermissions['view_pettycashes'] != 'none')
                    <x-sub-menu-item :link="route('pettycashes.index')" :text="__('app.menu.pettycashes')" />
                @endif
                @if (in_array('financeExecutors', user_modules()) && $sidebarUserPermissions['view_financeExecutors'] != 5 && $sidebarUserPermissions['view_financeExecutors'] != 'none')
                    <x-sub-menu-item :link="route('financeExecutors.index')" :text="__('app.menu.financeExecutors')" />
                @endif
                @if (in_array('accChecks', user_modules()) && $sidebarUserPermissions['view_accChecks'] != 5 && $sidebarUserPermissions['view_accChecks'] != 'none')
                 <x-sub-menu-item :link="route('accChecks.index')" :text="__('app.menu.accChecks')" />
                @endif  
    ...
    @if (in_array('reports', user_modules()) && ($sidebarUserPermissions['view_task_report'] == 4 || $sidebarUserPermissions['view_time_log_report'] == 4 || (isset($sidebarUserPermissions['view_expense_report']) && $sidebarUserPermissions['view_expense_report'] == 4) || $sidebarUserPermissions['view_finance_report'] != 5 || $sidebarUserPermissions['view_income_expense_report'] == 4 || $sidebarUserPermissions['view_leave_report'] != 5 || $sidebarUserPermissions['view_attendance_report'] == 4 || $sidebarUserPermissions['view_lead_report'] == 4 || $sidebarUserPermissions['view_sales_report'] == 4 || $sidebarUserPermissions['view_fa_progress_report'] == 4) && ($sidebarUserPermissions['view_task_report'] != 'none' || $sidebarUserPermissions['view_time_log_report'] != 'none' || $sidebarUserPermissions['view_finance_report'] != 'none' || $sidebarUserPermissions['view_income_expense_report'] != 'none' || $sidebarUserPermissions['view_leave_report'] != 'none' || $sidebarUserPermissions['view_attendance_report'] != 'none' || $sidebarUserPermissions['view_lead_report'] != 'none' || $sidebarUserPermissions['view_sales_report'] != 'none' || (isset($sidebarUserPermissions['view_expense_report']) && $sidebarUserPermissions['view_expense_report'] != 'none')|| (isset($sidebarUserPermissions['view_fa_progress_report']) && $sidebarUserPermissions['view_fa_progress_report'] != 'none')))
        <x-menu-item icon="graph-up" :text="__('app.menu.reports')">
            ...
            <div class="accordionItemContent pb-2">
                ...
                @endif
                @if (isset($sidebarUserPermissions['view_fa_progress_report']) && $sidebarUserPermissions['view_fa_progress_report'] == 4 && $sidebarUserPermissions['view_fa_progress_report'] != 'none' && in_array('reports', user_modules()))
                    <x-sub-menu-item :link="route('fa-report.index')" :text="__('app.menu.faReport')" />
                @endif
            </div>
        </x-menu-item>
    @endif

    @php $role = user()->role->last(); @endphp

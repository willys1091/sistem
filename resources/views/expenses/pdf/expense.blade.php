...
<body>
    <div style="text-align:center;background-color:#d3d3d3;color:#fff;font-size: 20px;padding-top:5px;padding-bottom:5px;"><b>Advance Request Form</b></div>
    <div>
        <table>
            <tr>
        ...
        <table>
            ...
            <tr>
                ...
                <td class="row pl">Payment For</td>
                <td class="row">:</td>
                <td class="row pl br"><b>{{ $header->category->category_name??'' }}</b></td>
            </tr>
            <tr>
                ...
                <tr>
                    <td class="row bt bl br bb" colspan="6">
                        ...
                        <tr>
                            ...
                            <td class="row pl">{{ $d->expenseCategoryDetail->category_name}}</td>
            ...
            <tr>
                <td class="row bt bl br bb" colspan="6">
                    ...
                    <tr>
                        ...
                        <td width="120" class="row pl" style="background-color:#d3d3d3;"><b>Date</b></td>

        ...
        <x-form id="save-expense-data-form">
            ...
            <div class="add-client bg-white rounded">
                ...
                <div class="row p-20">
                    ...
                    <div class="col-md-6 col-lg-4">
                        <x-forms.select fieldId="client_id" fieldName="client_id" :fieldLabel="__('app.client')" fieldRequired="true" search="true">
                            ...
                            @foreach ($clients as $client)
                                <option @selected($client->id == $expense->client_id) value="{{ $client->id }}">{{ $client->company_name }}</option>
                            @endforeach
                        </x-forms.select>
                    </div>
                    <div class="col-md-6 col-lg-4">
                    ...
                    <div class="col-md-4">
                        <x-forms.label class="mt-3" fieldId="category_id" :fieldLabel="__('modules.expenses.expenseCategory')" fieldRequired="true"></x-forms.label>
                        <x-forms.input-group>
                            <select class="form-control select-picker" name="category_id" id="expense_category_id" data-live-search="true" disabled>
                                <option value="">--</option>
                                @foreach ($categories as $category)
                                    <option @selected($category->id == $expense->category_id) value="{{ $category->id }}">{{ $category->category_name }}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="col-md-6 col-lg-3 expense_price">
                        <x-forms.number class="mr-0 mr-lg-2 mr-md-2" :fieldLabel="__('app.amount')" fieldName="price" fieldRequired="true" fieldId="price" :fieldPlaceholder="__('placeholders.price')" :fieldValue="$expense->price" />
                    </div>
                    <div class="col-md-6 col-lg-4">
                        ...
                        <x-forms.input-group>
                            <select class="form-control select-picker" name="urgency" id="urgency" data-live-search="true" data-size="8">
                                <option @selected($expense->urgency == 'normal') value="normal">Normal</option>
                                <option @selected($expense->urgency == 'urgent') value="urgent">Urgent</option>
                            </select>
                        </x-forms.input-group>
                    </div>
                    <div class="col-md-6 col-lg-4">
                        ...
                        <x-forms.input-group>
                            <select class="form-control select-picker" name="payment_type" id="payment_type" data-live-search="true" data-size="8">
                                <option @selected($expense->payment_type == 'transfer') value="transfer">Transfer</option>
                                <option @selected($expense->payment_type == 'cash') value="cash">Cash</option>
                            </select>
                        </x-forms.input-group>
                    </div>
                    <div class="col-md-4">
                    ...
                    <div class="col-md-4 payType">
                        <x-forms.text :fieldLabel="__('modules.expenses.payee')" fieldName="payee" fieldId="payee" :fieldValue="$expense->payee" fieldRequired="true"/>
                    </div>
                    <div class="col-md-6 col-lg-4 payType">
                        <x-forms.number class="mr-0 mr-lg-2 mr-md-2" :fieldLabel="__('app.menu.bankaccount')" fieldName="bank_account" fieldRequired="true" fieldId="bank_account" :fieldValue="$expense->bank_account"/>
                    </div>
                    <div class="col-md-4 payType">
                        <x-forms.text :fieldLabel="__('modules.expenses.bankName')" fieldName="bank_name" fieldId="bank_name" :fieldValue="$expense->bank_name" fieldRequired="true"/>
                    </div>
                ...
                <x-form-actions>
                    ...
                    <x-forms.button-cancel :link="route('expenses.index')" class="border-0">@lang('app.cancel')</x-forms.button-cancel>
                </x-form-actions>
            </div>
        </x-form>
    </div>
...
<script>
    $(document).ready(function() {
        ...
        if('{{ $expense->category->is_detail }}' == '1') {
            $('#price').val(0);
            $('.expense_price').hide();
        }else{
             $('.expense_price').show();

<x-form id="save-expense-data-form">
    ...
    <div class="modal-body">
        <div class="portlet-body">
            ...
            <div class="row">
                <div class="col-md-12">
                    <x-forms.text :fieldLabel="__('modules.expenses.remarks')" fieldName="remarks" fieldRequired="true" fieldId="remarks" autocomplete="off"/>
                </div>
                <div class="col-md-12">
                ...
                <div class="col-md-6">
                    <x-forms.datepicker fieldId="purchase_date" fieldRequired="true"
                        :fieldLabel="__('modules.expenses.purchaseDate')" fieldName="estdate"
...
<script>
    $(document).ready(function() {
        ...
        $('#save-expense-form').click(function() {
            const url = "{{ route('expenses.detail.store') }}";

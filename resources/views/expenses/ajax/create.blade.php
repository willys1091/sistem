@php $addExpenseCategoryPermission = user()->permission('manage_expense_category'); @endphp
<div class="row">
    <div class="col-sm-12">
        <x-form id="save-expense-data-form">
            <div class="add-client bg-white rounded">
                <h4 class="mb-0 p-20 f-21 font-weight-normal text-capitalize border-bottom-grey">@lang('app.expenseDetails')</h4>
                <div class="row p-20">
                    <div class="col-md-6 col-lg-4">
                        <x-forms.text class="mr-0 mr-lg-2 mr-md-2" :fieldLabel="__('modules.expenses.itemName')" fieldName="item_name" fieldRequired="true" fieldId="item_name"
                    ...
                    <div class="col-md-6 col-lg-4 expense_price">
                    ...
                    <div class="col-md-4 payType">
                        <x-forms.text :fieldLabel="__('modules.expenses.payee')" fieldName="payee" fieldId="payee" fieldRequired="true"/>
                    </div>
                    ...
                    <div class="col-md-4 payType">
                        <x-forms.text :fieldLabel="__('modules.expenses.bankName')" fieldName="bank_name" fieldId="bank_name" fieldRequired="true"/>
                    </div>
                    ...
                    <div class="col-lg-12">
                        <x-forms.file :fieldLabel="__('app.attachment')" fieldName="bill" fieldId="bill" allowedFileExtensions="pdf png jpg jpeg" :popover="__('messages.fileFormat.multipleImageFile')" />
                    </div>
                </div>
...
<script>
    $(document).ready(function() {
        ...
        $('#expense_category_id').change(function() {
            ...
            $.ajax({
                type: "POST",
                url: "{{ route('expenses.check_category_detail') }}",

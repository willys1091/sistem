            ...
            <div class="col-12 px-0 pb-3 d-lg-flex d-md-flex d-block">
                ...
                <p class="mb-0 text-dark-grey f-14">
                    @if (!is_null($expense->bill))
                        <a target="_blank" href="{{ $expense->bill_url }}" class="text-darkest-grey">@lang('app.view') @lang('app.bill') <i class="fa fa-link"></i></a>&nbsp
            ...
            <div class="col-12 px-0 pb-3 d-lg-flex d-md-flex d-block">
                ...
                <p class="mb-0 text-dark-grey f-14">
                    @if ($expense->status == 'draft')
                        <x-status :value="__('app.'.$expense->status)" color="grey" />
                    @elseif ($expense->status == 'active')
                        <x-status :value="__('app.'.$expense->status)" color="light-blue" />
                    @elseif ($expense->status == 'on progress')
                        <x-status :value="__('app.'.$expense->status)" color="yellow" />
                    @elseif ($expense->status == 'approved')
                        <x-status :value="__('app.'.$expense->status)" color="light-green" />
                    @else

...
<x-form id="save-settlement-data-form">
    ...
    <div class="modal-footer">
        <x-forms.button-primary id="save-settlement-form" class="mr-3" icon="check">@lang('app.submit')</x-forms.button-primary>
...
<script>
    $(document).ready(function() {
        ...
        $('#save-settlement-form').click(function() {
            ...
            const url = "{{ route('settlements.response_action') }}";

                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="border-bottom-0 btrr-mbl btlr">
                                        <input type="text" class="f-14 border-0 w-100 item_name" name="item_name[]" placeholder="@lang('modules.pettycashes.itemName')" value="{{ $item->item_name }}">
                                    </td>
                ...
                +'<table width="100%">'
                    +'<tbody>'
                        +'<tr class="text-dark-grey font-weight-bold f-14">'
                            ...
                            +'<tr>'
                                +'<td class="border-bottom-0 btrr-mbl btlr">'
                                    +`<input type="text" class="f-14 border-0 w-100 item_name" name="item_name[]" placeholder="@lang('modules.pettycashes.itemName')">`
                                    +'</td>'
                                    +'<td class="border-bottom-0 d-block d-lg-none d-md-none">'

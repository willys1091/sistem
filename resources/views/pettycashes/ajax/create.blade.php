@php $addPettycashCategoryPermission = user()->permission('manage_pettycash_category'); @endphp
<div class="row">
    <div class="col-sm-12">
        <x-form id="save-pettycash-data-form">
            <div class="add-client bg-white rounded">
                <h4 class="mb-0 p-20 f-21 font-weight-normal text-capitalize border-bottom-grey">@lang('app.pettycashDetails')</h4>
                <div class="row p-20">
                    <div class="col-md-6 col-lg-4">
                        <x-forms.text class="mr-0 mr-lg-2 mr-md-2" :fieldLabel="__('modules.pettycashes.itemName')" fieldName="item_name" fieldRequired="true" fieldId="item_name"
                            :fieldPlaceholder="__('placeholders.pettycash.item')" />
                    </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <x-forms.input-group>
                            <select class="form-control select-picker" name="category_id" id="pettycash_category_id" data-live-search="true" >
                                <option value="">--</option>
                            ...
                            @if ($addPettycashCategoryPermission == 'all' || $addPettycashCategoryPermission == 'added')
                                <x-slot name="append">
                                    <button id="addPettycashCategory" type="button" class="btn btn-outline-secondary border-grey" data-toggle="tooltip" data-original-title="{{__('modules.pettycashCategory.addPettycashCategory') }}">@lang('app.add')</button>
                                </x-slot>
                            @endif
                        </x-forms.input-group>
                    </div>
                    <div class="col-md-6 col-lg-4 pettycash_price">
                    ...
                    <div class="col-md-6 col-lg-4" style="display:none;">
                        <x-forms.label class="mt-3" fieldId="urgency" :fieldLabel="__('app.urgency')"></x-forms.label>
                        <x-forms.input-group>
                    ...
                    <div class="col-md-4">
                        <x-forms.text :fieldLabel="__('modules.pettycashes.purchaseFrom')" fieldName="purchase_from" fieldId="purchase_from" :fieldPlaceholder="__('placeholders.pettycash.vendor')" />
                    </div>
                    <div class="col-md-4 payType">
                        <x-forms.text :fieldLabel="__('modules.pettycashes.payee')" fieldName="payee" fieldId="payee" fieldRequired="true"/>
                    </div>
                    ...
                    <div class="col-md-4 payType">
                        <x-forms.text :fieldLabel="__('modules.pettycashes.bankName')" fieldName="bank_name" fieldId="bank_name" fieldRequired="true"/>
                    </div>
...
<script>
    $(document).ready(function() {
        ...
        $('#save-pettycash-form').click(function() {
            ...
            const url = "{{ route('pettycashes.store') }}";
        ...
        $('#addPettycashCategory').click(function() {
            ...
            const url = "{{ route('pettycashCategory.create') }}?user_id="+userId;
        ...
        $('#pettycash_category_id').change(function() {
            ...
            $.ajax({
                type: "POST",
                url: "{{ route('pettycashes.check_category_detail') }}",
        ...
        $('body').on('change', '#user_id', function(){
            ...
            let data = $('#save-pettycash-data-form').serialize();
        ...
        $('body').on('change', '#pettycash_category_id', function(){

...
<body>
    <div style="text-align:center;background-color:#d3d3d3;color:#fff;font-size: 20px;padding-top:5px;padding-bottom:5px;"><b>Payment Request Form</b></div>
    <div>
        <table>
            <tr>
                ...
                <tr>
                    <td class="row bt bl br bb" colspan="6">
                        ...
                        <tr>
                            ...
                            <td class="row pl">{{ $d->reimbursementsCategoryDetail->category_name }}</td>

...
<x-form id="addProjectMilestoneForm">
    <div class="modal-body">
        ...
        <div class="row">
            <div class="col-md-6">
                <x-forms.text fieldId="milestone_title" :fieldLabel="__('modules.projects.milestoneTitle')" fieldName="milestone_title" fieldRequired="true" :fieldPlaceholder="__('placeholders.milestone')"></x-forms.text>
            </div>
            <div class="col-md-6">
                <x-forms.number fieldId="cost" :fieldLabel="__('modules.projects.milestoneCost')" fieldName="cost" :fieldPlaceholder="__('placeholders.price')"></x-forms.number>
            </div>
            <div class="col-md-6">
            ...
            <div class="col-md-6" style="display:none">
                <x-forms.select fieldId="add_to_budget" :fieldLabel="__('modules.projects.addCostProjectBudget')" fieldName="add_to_budget">

@php $addTimelogPermission = user()->permission('add_timelogs'); @endphp
<div class="row py-3 py-lg-5 py-md-5">
    <div class="col-lg-12 col-md-12 mb-4 mb-xl-0 mb-lg-4">
        <div class="d-flex" id="table-actions">
            @if (($addTimelogPermission == 'all' || $addTimelogPermission == 'added') && !$project->trashed())
                <x-forms.link-primary :link="route('timelogs.create').'?default_project='.$project->id" class="mr-3 openRightModal float-left" icon="plus">
                    ...
                    <div class="select-box py-2 px-lg-2 px-md-2 px-0 mr-3">
                        ...
                        <div class="input-group bg-grey rounded">
                            <div class="input-group-prepend">
                                <span class="input-group-text bg-additional-grey"><i class="fa fa-search f-13 text-dark-grey"></i></span>
                            </div>
...
<script>
    ...
    $('body').on('click', '.reject-timelog', function () {
        ...
        let url = "{{ route('timelogs.reject_timelog', ':id') }}";
        url = url.replace(':id', id);

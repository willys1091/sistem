...
return array(
    ...
    'projects' => array(
        ...
        'expenses_total' => 'Advances',
        'projectExpenseInfo' => 'Calculated from advances module',
    ...
    'invoices' => array(
        ...
        'draft' => 'Draft',
        'buy' => 'Buy',
        'infinite' => 'For Infinite Advances',
        'assignMe' => 'Assign to me',
        ...
        'unitType' => 'Unit Type',
        'unitType2' => 'Unit Type 2',
        'unitType3' => 'Unit Type 3',
    ...
    'emailSettings' => array(
        ...
        'expenseAdded' => 'New Advance (Added by Admin)',
        'expenseMember' => 'New Advance (Added by Member)',
        'expenseStatus' => 'Advance Status Changed',
        ...
        'new-expenseadded-by-admin' => 'New Advance (Added by Admin)',
        'new-expenseadded-by-member' => 'New Advance (Added by Member)',
        'expense-status-changed' => 'Advance Status Changed',
    ...
    'expenses' => array(
        'addExpense' => 'Add Advance',
        'editExpense' => 'Edit Advance',
        'itemName' => 'Title',
        'purchaseDate' => 'Date',
        'purchaseFrom' => 'Purchased From',
        'updateExpense' => 'Update Advance',
        'infinite' => 'For Infinite Advance',
        'expenseCategory' => 'Advance Category',
        'attachBill' => 'Attach Bill',
        'removeBill' => 'Remove Bill',
        'approvedBy' => 'Approved By',
        'payrollExpenseReport' => 'Payroll Advance Report',
        'expenseBill' => 'Advance Bill',
        'payee' => 'Payee',
        'bankName' => 'Bank Name',
        'overview' => 'Overview',
        'detail' => 'Detail',
        ...
        'taxNo' => 'Tax No',
        'isTaxNo' => 'Is Tax No',
        'amountBasic' => 'Amount Basic',
        'amount' => 'Amount',
        'typetaxAmount' => 'Type Amount',
        'typePph1' => 'Type PPH 1',
        'pph1Basic' => 'PPH 1 Basic',
        'pph1' => 'PPH 1',
        'typePph2' => 'Type PPH 2',
        'pph2Basic' => 'PPH 2 Basic',
        'pph2' => 'PPH 2',
        'typePpn' => 'Type PPN',
        'ppnBasic' => 'PPN Basic',
        'ppn' => 'PPN',
        'taxTotalBasic' => 'Total Basic',
        'taxTotal' => 'Total',
        'transferDate' => 'Transfer Date',
        'accNo'=> 'Accounting No',
    ),
    'expensesRecurring' => array(
        'addExpense' => 'Add Recurring Advance',
        'itemName' => 'Title',
        'purchaseDate' => 'Date',
        'purchaseFrom' => 'Purchased From',
        'updateExpense' => 'Update Advance',
        ...
        'immediateExpense' => 'Immediate start ( Advance will generate from now )',
        'nextExpense' => 'Next Advance',
        'nextExpenseDate' => 'Next Advance Date will be',
        'currentExpenseDate' => 'First Advance will be generated on',
        'expenseGenerated' => 'The advance will be generated',
        'completedTotalExpense' => 'Completed/Total Advance',
        'firstExpenseDate' => 'First Advance Date',
    ),
    'reimbursements' => array(
        'addReimbursement' => 'Add Payment',
        'editReimbursement' => 'Edit Payment',
        'itemName' => 'Title',
        'purchaseDate' => 'Date',
        'purchaseFrom' => 'Purchased From',
        'updateReimbursement' => 'Update Payment',
        'infinite' => 'For Infinite Payments',
        'reimbursementCategory' => 'Payment Category',
        'attachBill' => 'Attach Bill',
        'removeBill' => 'Remove Bill',
        'approvedBy' => 'Approved By',
        'payrollReimbursementReport' => 'Payroll Payment Report',
        'reimbursementBill' => 'Payment Bill',
        'payee' => 'Payee',
        'bankName' => 'Bank Name',
        'overview' => 'Overview',
        'detail' => 'Detail',
    ...
    'reimbursementsRecurring' => array(
        'addReimbursement' => 'Add Recurring Payment',
        'itemName' => 'Title',
        'purchaseDate' => 'Date',
        'purchaseFrom' => 'Purchased From',
        'updateReimbursement' => 'Update Payment',
        ...
        'dayOfMonth' => 'Day Of Month',
        'lastPaymentDate' => 'Last Payment Date',
        'immediateReimbursement' => 'Immediate start ( Payment will generate from now )',
        'nextReimbursement' => 'Next Payment',
        'nextReimbursementDate' => 'Next Payment Date will be',
        'currentReimbursementDate' => 'First Payment will be generated on',
        'reimbursementGenerated' => 'The advance will be generated',
        'completedTotalReimbursement' => 'Completed/Total Payment',
        'firstReimbursementDate' => 'First Payment Date',
    ),

    'settlements' => array(
        'addSettlement' => 'Add Settlement',
        'code' => 'Code',
        'expenseCode' => 'Advance Code',
        ...
        'itemName' => 'Title',
        'purchaseDate' => 'Date',
        'settlementCategory' => 'Advance Category',
        'remarks' => 'Remarks',
        'isTax' => 'Is Tax',
        'procurement' => 'Procurement',
        'subject' => 'Subject',
    ...
    'module' => array(
        ...
        'financeExecutors' => 'Finance Executors',
        'accChecks' => 'Accounting Checks',
        'timelogs' => 'Time Logs',
    ...
    'expenseCategory' => array(
        'expenseCategoryReport' => 'Advance Category Report',
        'addExpenseCategory' => 'Add Advance Category',
        'categoryName' => 'Category Name',
        'allowRoles' => 'Allow Roles',
        'assignToRole' => 'Assign To Roles',
    ),
    'pettycashCategory' => array(
        'pettycashCategoryReport' => 'Pettycash Category Report',
        'addPettycashCategory' => 'Add Pettycash Category',
        'categoryName' => 'Category Name',
        'allowRoles' => 'Allow Roles',
        'assignToRole' => 'Assign To Roles',
        'isDetail' => 'Is Detail',
    ),
    'settlementCategory' => array(
        'settlementCategoryReport' => 'Settlement Category Report',
        'addSettlementCategory' => 'Add Settlement Category',
        'categoryName' => 'Category Name',
        'allowRoles' => 'Allow Roles',
        'assignToRole' => 'Assign To Roles',
    ),
    'reimbursementCategory' => array(
        'reimbursementCategoryReport' => 'Payment Category Report',
        'addReimbursementCategory' => 'Add Payment Category',
        'categoryName' => 'Category Name',
        'allowRoles' => 'Allow Roles',
        'assignToRole' => 'Assign To Roles',
        'isDetail' => 'Is Detail',
    ...
    'emailNotification' => array(
        ...
        'new-expense-added-by-admin' => 'New Advance/Added by Admin',
        'new-expense-added-by-member' => 'New Advance/Added by Member',
        ...
        'recurring-expense-status-updated' => 'Recurring Advance Status Updated',
    ...
    'bankaccount' => array(
        ...
        'expense-added' => 'Advance Added',
        'expense-modified' => 'Advance Modified',
        'expense-deleted' => 'Advance Deleted',
